...
const BranchNode: (props: BranchNodeProps) => JSX.Element = ({
  ...
  const { refer } = branch!;
  // const { lines, deleteNode, updateView, deleteErrors } = useContext(WFC) as WorkFlowCtx;
      ...
      <div className="condition-node-box">
        ...
        >
          ...
          <div className="title-wrapper" style={{ display: 'flex' }}>
            ...
            {/* {(refer as DagLine).rules && <div className="delete-icon" onClick={() => deleteNode(id, lines!)}></div>} */}
          </div>
